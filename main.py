...
# Import kociemba with fallback to custom implementation
try:
    import kociemba
except ImportError:
    # Use our custom solver if kociemba is not available
    from kociemba_solver import solve as kociemba_solve
    class KociembaWrapper:
        def solve(self, cube_string):
            return kociemba_solve(cube_string)
    kociemba = KociembaWrapper()
